...
namespace DTO
{
    public class DTO_NhanVien
    {
        ...
        private byte[] _anhNhanVien;

        public DTO_NhanVien()
        { }

        public DTO_NhanVien(int id, string ho, string ten, DateTime ngaysinh, string gioitinh, string cmnd, string diachi, string sodt,
                string email, DateTime ngaybatdau, byte[] anh)
        {
            this._idNhanVien = id;
            this._ho = ho;
            this._ten = ten;
        ...
        public byte[] AnhNhanVien { get => _anhNhanVien; set => _anhNhanVien = value; }
    }
}
